...
from .operations import DigitalOceanClientOperationsMixin
...
class DigitalOceanClient(DigitalOceanClientOperationsMixin):
    """DigitalOceanClient.

    :param credential: Credential needed for the client to connect to Azure.
    :type credential: ~azure.core.credentials.TokenCredential
    :param base_url: Service URL. Default value is "http://petstore.swagger.io/v1".
    :type base_url: str
    """
    ...
    def __init__(
        ...
        base_url="http://petstore.swagger.io/v1",  # type: str
        **kwargs  # type: Any
    ):
        # type: (...) -> None
