...
from ...operations._swagger_petstore_operations import build_create_pets_request, build_list_pets_request, build_show_pet_by_id_request
T = TypeVar('T')
ClsType = Optional[Callable[[PipelineResponse[HttpRequest, AsyncHttpResponse], T, Dict[str, Any]], Any]]

class SwaggerPetstoreOperationsMixin:
